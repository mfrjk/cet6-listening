(() => {
  ...
  function mockHistoryDetailTemplate(group) {
    ...
    const total = (set.groups || []).reduce((sum, item) => sum + (item.questions || []).length, 0);
